...
class AzureOpenAIEmbedder(Embedder):
    ...
    user: str | None = None
    api_key: str | None = getenv("AZURE_EMBEDDER_OPENAI_API_KEY")
    api_version: str = getenv("AZURE_EMBEDDER_OPENAI_API_VERSION", "2024-10-21")
    azure_endpoint: str | None = getenv("AZURE_EMBEDDER_OPENAI_ENDPOINT")
    azure_deployment: str | None = getenv("AZURE_EMBEDDER_DEPLOYMENT")
