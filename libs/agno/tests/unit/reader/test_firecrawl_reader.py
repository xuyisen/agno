...
def test_scrape_basic(mock_scrape_response):
    ...
    with patch("agno.document.reader.firecrawl_reader.V1FirecrawlApp") as V1MockFirecrawlApp:
        # Set up mock
        mock_app = V1MockFirecrawlApp.return_value
        ...
        V1MockFirecrawlApp.assert_called_once_with(api_key=None)
...
def test_scrape_with_api_key_and_params():
    ...
    with patch("agno.document.reader.firecrawl_reader.V1FirecrawlApp") as V1MockFirecrawlApp:
        ...
        V1MockFirecrawlApp.assert_called_once_with(api_key=api_key)
...
async def test_async_scrape_basic(mock_scrape_response):
    ...
    with patch("asyncio.to_thread") as mock_to_thread, patch("firecrawl.V1FirecrawlApp") as V1MockFirecrawlApp:
