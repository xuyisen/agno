...
def test_scrape_basic(mock_scrape_response):
    ...
    with patch("agno.document.reader.firecrawl_reader.V1FirecrawlApp") as MockFirecrawlApp:
        # Set up mock
...
async def test_async_scrape_basic(mock_scrape_response):
    ...
    with patch("asyncio.to_thread") as mock_to_thread, patch("firecrawl.V1FirecrawlApp") as MockFirecrawlApp:
